...
CA jetable, enrôlement anonyme auto-approuvé, SoftHSM en lieu d'un HSM
...
| `<release>-generated` (Secret) | Mots de passe MariaDB, PIN SoftHSM, clé du coffre de données, mot de passe WebDAV — générés une fois et stables d'un `helm upgrade` à l'autre (motif `lookup`) |
